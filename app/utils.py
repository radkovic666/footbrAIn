...
step_progress("Step 5a: Recalculating formation strength for 2025 season")
current_season_start = pd.to_datetime('2025-08-01')
...
feature_info = {
    'feature_names': list(selected_features),  # The features selected by RFE
    'model_type': 'stacking_classifier'
}
joblib.dump(feature_info, "match_outcome_model_v4_features.pkl")
